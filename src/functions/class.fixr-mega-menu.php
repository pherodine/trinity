...
class fixr_mega_menu extends Walker_Nav_Menu {

    function __construct($css_class_prefix) {

        $this->css_class_prefix = $css_class_prefix;
        $this->user_class_in = $user_class_in;
    ...
    function start_lvl(&$output, $depth = 1, $args=array()) {
        ...
        // Add a back button to the sub-menu
        $output .= "\t<li class=\"main-nav-list__sub-menu__item\">\n";
        $output .= "\t\t<a class=\"main-nav-list__sub-menu__link main-nav-list__sub-menu__link--back\" href=\"#\">Back</a>\n";
        $output .= "\t</li>\n";
    }
